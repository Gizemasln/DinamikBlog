...
namespace DataAccessLayer.Concrete
{
    public class Context : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("server=DESKTOP-C6T2D9P\\SQLEXPRESS;database=CoreBlogDb;integrated security=true; TrustServerCertificate=True");
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Match>().HasOne(x => x.GuesTeam).WithMany(y => y.AwayMatches).HasForeignKey(z => z.GuesTeamID).OnDelete(DeleteBehavior.ClientSetNull);
